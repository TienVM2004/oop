...
public class StringCodeTest {
	...
	@Test
	public void intergalacticalIntersect() {
		assertEquals(true, StringCode.stringIntersect("aabb", "abab", 2));
		assertEquals(false, StringCode.stringIntersect("aaaaaaaaa", "abbbbbbbbbbbab", 5));
		assertEquals(true, StringCode.stringIntersect("gggggggggggg", "ggggggggggggggb", 6));
	}
}
